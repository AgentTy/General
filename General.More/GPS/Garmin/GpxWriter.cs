...
namespace General.GPS.GPX
{
    public class GpxWriter : IDisposable
    {
        ...
        public void WriteMetadata(GpxMetadata metadata)
        {
            ...
            if (!IsNullOrWhiteSpace(metadata.Name)) Writer_.WriteElementString("name", metadata.Name); //IsNullOrWhiteSpace
            if (!IsNullOrWhiteSpace(metadata.Description)) Writer_.WriteElementString("desc", metadata.Description); //IsNullOrWhiteSpace
            ...
            if (!IsNullOrWhiteSpace(metadata.Keywords)) Writer_.WriteElementString("keywords", metadata.Keywords); //IsNullOrWhiteSpace
        ...
        private void WriteWayOrRoutePoint(GpxWayPoint wayPoint)
        {
            ...
            if (!IsNullOrWhiteSpace(wayPoint.Name)) Writer_.WriteElementString("name", wayPoint.Name); //IsNullOrWhiteSpace
            if (!IsNullOrWhiteSpace(wayPoint.Comment)) Writer_.WriteElementString("cmt", wayPoint.Comment); //IsNullOrWhiteSpace
            if (!IsNullOrWhiteSpace(wayPoint.Description)) Writer_.WriteElementString("desc", wayPoint.Description); //IsNullOrWhiteSpace
            if (!IsNullOrWhiteSpace(wayPoint.Source)) Writer_.WriteElementString("src", wayPoint.Source); //IsNullOrWhiteSpace
            ...
            if (!IsNullOrWhiteSpace(wayPoint.Symbol)) Writer_.WriteElementString("sym", wayPoint.Symbol); //IsNullOrWhiteSpace
            if (!IsNullOrWhiteSpace(wayPoint.Type)) Writer_.WriteElementString("type", wayPoint.Type); //IsNullOrWhiteSpace
        ...
        private void WritePerson(string elementName, GpxPerson person)
        {
            ...
            if (!IsNullOrWhiteSpace(person.Name)) Writer_.WriteElementString("name", person.Name); //IsNullOrWhiteSpace
        ...
        private void WriteLink(string elementName, GpxLink link)
        {
            ...
            if (!IsNullOrWhiteSpace(link.Text)) Writer_.WriteElementString("text", link.Text); //IsNullOrWhiteSpace
            if (!IsNullOrWhiteSpace(link.MimeType)) Writer_.WriteElementString("type", link.MimeType); //IsNullOrWhiteSpace
            Writer_.WriteEndElement();
        }
