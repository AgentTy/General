...
namespace General.Utilities.IO
{
	/// <summary>
	...
	{
		#region Private level variables 
		private Stream stream;
		private StreamReader reader;
		private string m_strCurrentDataLine;
		private char _charSeperator = ',';
		#endregion
		...
		/// </summary>
		/// <param name="filename">The name of the file to be read.</param>
		public CSVReader(string filename, char seperator) : this(filename, null) 
		{ 
			_charSeperator = seperator;
		}
		...
		private string ParseCSVField(string data, ref int startSeparatorPosition) 
		{
			...
			int nextComma = data.IndexOf(_charSeperator, fromPos);
			if (nextComma == -1) 
			{
		...
		/// </summary>
		public string CurrentDataLine
		{
			get
			{
				return m_strCurrentDataLine;
			}
		}
		#endregion
	}
