...
namespace General.Model
{
    ...
    public class PostalAddress
    {
        ...
        /// </summary>
        [NonSerialized]
        protected string _strReference = null;
        /// <summary>
        /// Address1
        /// </summary>
        [NonSerialized]
        protected string _strAddress1 = null;
        /// <summary>
        /// Address2
        /// </summary>
        [NonSerialized]
        protected string _strAddress2 = null;
        /// <summary>
        /// Address3
        /// </summary>
        [NonSerialized]
        protected string _strAddress3 = null;
        /// <summary>
        /// City
        /// </summary>
        [NonSerialized]
        protected string _strCity = null;
        /// <summary>
        /// State
        /// </summary>
        [NonSerialized]
        protected string _strStateCode = null;
        /// <summary>
        /// State
        /// </summary>
        [NonSerialized]
        protected string _strStateName = null;
        /// <summary>
        /// Postal
        /// </summary>
        [NonSerialized]
        protected string _strPostalCode = null;
        /// <summary>
        /// Country
        /// </summary>
        [NonSerialized]
        protected string _strCountryCode = null;
        /// <summary>
        /// Country
        /// </summary>
        [NonSerialized]
        protected string _strCountryName = null;
        #endregion
        ...
        public string ToLocationString(bool blnShort)
        {
            ...
            if (_strStateCode != null && _strStateCode != "")
            {
                if (!String.IsNullOrWhiteSpace(_strStateName) && !blnShort)
            ...
            {
                if (!String.IsNullOrWhiteSpace(_strCountryName))
        ...
        public string ToCountryStateStringForUS()
        {
            if (_strCountryCode != "US")
                if (String.IsNullOrWhiteSpace(_strStateName))
