...
namespace General
{
	...
	public class F:StringFunctions
	{
        ...
        */
        ...
        public static bool SafeSelect(ref System.Web.UI.WebControls.DropDownList objList, string strValue)
        {
            foreach (System.Web.UI.WebControls.ListItem objItem in objList.Items)
            {
                if (objItem.Value == strValue)
        ...
        #region PermanentRedirect
        public static void PermanentRedirect(string strURL, bool blnEndResponse)
        {
            System.Web.HttpContext.Current.Response.StatusCode = 301;
            System.Web.HttpContext.Current.Response.Status = "301 Moved Permanently";
            System.Web.HttpContext.Current.Response.AddHeader("Location", strURL);
        ...
        public static string RenderControl(Control ctrl)
        {
            ...
            bool blnResetVisibility = false;
            if (!ctrl.Visible)
            {
                blnResetVisibility = true;
                ctrl.Visible = true;
            }
            #endregion
            ctrl.RenderControl(hw);
            #region Reset Visibility
            if (blnResetVisibility)
                ctrl.Visible = false;
            #endregion
